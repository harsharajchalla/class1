...
inc <- read.csv("C:/Users/HP/Downloads/Income.csv")
#income
...
churn <- read.csv("C:/Users/HP/Downloads/churn.csv")#churn
...
stats <- read.csv("C:/Users/HP/Downloads/Demographics.csv")#Demographics
# Alternatively, set working directory
# setwd("C:/Users/HP/OneDrive1/Desktop/CS-650/Class")
